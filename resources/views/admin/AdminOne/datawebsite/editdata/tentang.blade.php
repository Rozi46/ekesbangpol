        ...
        <div class="container-fluid text-left">
            <div class="row">
                ...
                <div class="col-md-12 bg_page_main form_action" line="hd_action">
                    <div class="col-md-12 hd_page_main">Data Tentang</div>
                                ...
                                <div class="col-md-12 bg_form_page">
                                    <div class="form_input text-left">
                                        <textarea id="field_isi" name="isi"
                                            class="ckeditor" placeholder="Isi tentang.."></textarea>
                        ...
                        <div class="row bg_data_page form_page content">
                            <div class="col-md-12 bg_form_page">
                                <div class="form-group form_input text-left">
                                    @if(($level_user['edittentang'] ?? 'No') === 'Yes')
...
@section('script')
    <script>
        $(document).ready(function () {
            ...
            * ========================================================= */
            const ROUTES = {
                detail : "{{ url('/admin/viewtentang') }}",
                update : "{{ url('/admin/updatetentang') }}"
            };
            ...
            * ========================================================= */
            function loadData() {
                $.ajax({
                    ...
                    error: function (xhr) {
                        console.log(xhr);
                        SystemToast('danger','Gagal memuat data tentang');
                    }
                });
            }
            ...
            * ========================================================= */
            $('#btnSaveForm').on('click', function () {
                ...
                /* ================= VALIDASI ================= */
                if (!isi) {
                    setValidation('Tentang wajib diisi');
                    return;
                }

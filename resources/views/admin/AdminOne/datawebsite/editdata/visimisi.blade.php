        ...
        <div class="container-fluid text-left">
            <div class="row">
                ...
                <div class="col-md-12 bg_page_main form_action" line="hd_action">
                    <div class="col-md-12 hd_page_main">Data Visi dan Misi</div>
                                ...
                                <div class="col-md-12 bg_form_page">
                                    <div class="form_input text-left">
                                        <textarea id="field_isi" name="isi"
                                            class="ckeditor" placeholder="Isi visi dan misi.."></textarea>
                        ...
                        <div class="row bg_data_page form_page content">
                            <div class="col-md-12 bg_form_page">
                                <div class="form-group form_input text-left">
                                    @if(($level_user['editvisimisi'] ?? 'No') === 'Yes')
...
@section('script')
    <script>
        $(document).ready(function () {
            ...
            * ========================================================= */
            const ROUTES = {
                detail : "{{ url('/admin/viewvisimisi') }}",
                update : "{{ url('/admin/updatevisimisi') }}"
            };
            ...
            * ========================================================= */
            function loadData() {
                $.ajax({
                    ...
                    error: function (xhr) {
                        console.log(xhr);
                        SystemToast('danger','Gagal memuat data visi dan misi');
                    }
                });
            }
            ...
            * ========================================================= */
            $('#btnSaveForm').on('click', function () {
                ...
                /* ================= VALIDASI ================= */
                if (!isi) {
                    setValidation('Visi dan misi wajib diisi');
                    return;
                }

...
@section('style')
    <style>
        ...
        .field-error-msg {
            ...
            /* Paksa warna merah di semua child element */
            color: #e0294a !important;
        }
        ...
        .field-wrapper.is-invalid ~ .field-error-msg {
            display: flex !important;
        }

        .field-error-msg .fa-info-circle {
                        ...
                        <div class="row bg_data_page">
                            <div class="table_data freezeHead freezeCol">
                                <table class="table_view table-striped table-hover">
                                    ...
                                    <tbody id="kategoriarsipTableBody">
                                        <tr>
        ...
        $(function () {
            ...
            * ========================================================= */
            ...
            function renderTable(res) {
                ...
                $('#kategoriarsipTableBody').html(html);
            }

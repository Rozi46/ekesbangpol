        ...
        <table class="table_view table-striped table-hover">
            <thead>
                <tr>
                    ...
                    <th style="width:250px; text-align: center;">Pangkat</th>
                    <th style="width:70px; text-align: center;">Golongan</th>
                    <th style="width:70px; text-align: center;">Ruang</th>
            ...
            <tbody>
                @forelse($results['data'] as $view_data)
                    <tr>
						...
						<td class="strtable" >{{$view_data['pangkat']}}</td>
                        <td class="strtable" style="text-align:center;">{{$view_data['golongan']}}</td>
                        <td class="strtable" style="text-align:center;">{{$view_data['ruang']}}</td>

							...
							<div class="col-md-12 bg_act_page_main">
								<div class="row">
									<div class="col-xl-12 col_act_page_main text-left">
										...
										@if($level_user['newlevelusers'] == 'Yes')<a load="true" href="/admin/newlevelusers"><button type="button" class="btn btn-primary" id="btnTambah"><i class="fa fa-plus"></i> Tambah Data</button></a>@endif
									</div>
								</div>
							</div>
                        </div>
												...
												<?php $no = 0;?> @forelse($results['data'] as $view_data) <?php $no++ ;?>
													<script>
														function ViewData{{$no}}() {
															loadingpage(2000);
															window.location.href = "/admin/viewlevel?d={{$view_data['code_data']}}";
														}
													</script>

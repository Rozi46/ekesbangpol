								...
								<div class="row">
									<div class="col-xl-12 col_act_page_main text-left">
                                        ...
                                        @if($res_user['level'] == 'LV5677001' && $results['results']['setting']['manual_book'] != Null)
                                           <button type="button" class="btn btn-primary" onclick="viewmanualbook()"><i class="fa fa-search"></i> View Data</button> 
                                           <button type="button" class="btn btn-info" onclick="downloadData()"><i class="fa fa-download"></i> Download Data</button>
                                                ...
                                                <div class="form-group row form_input text-left">
                                                    ...
                                                    <div class="col-sm-10 input">
                                                        <div class="input-group-append">
                                                            <button type="button" class="btn btn-success" style="margin-top: 0px;" onclick="UploadData()"><i class="fa fa-upload"></i> Upload Data</button>
                                                        </div>

								...
								<div class="row">
									<div class="col-xl-12 col_act_page_main text-left">
                                        ...
                                        @if($res_user['level'] == 'LV5677001')
                                            <button type="button" class="btn btn-primary" name="btn_save" onclick="loadingpage(20000),SaveData('form_data')"><i class="fa fa-save"></i> Simpan Data</button>
										...
										<div class="col-md-12 bg_form_page"> 
											@foreach ($list_akses['menu'] as $view_menu)
												<div class="col-md-12 col_level">
													<div class="bg_level">
														<div class="level">
															<span menu="{{$view_menu['nama_akses']}}" line="btn_level"><i class="fa fa-caret-right"></i> {{$view_menu['no_urut']}}. {{$view_menu['nama_menu']}} | {{$view_menu['nama_akses']}}</span> @if($res_user['level'] == 'LV5677001')<button type="button" class="btn btn-danger" style="padding:2px 5px; font-size:12px;" name="del_menu_{{$view_menu['id']}}"><i class="fa fa-trash" style="color:#fff;"></i> Hapus</button>@endif
														</div>
													</div>
												</div>
												<script>
